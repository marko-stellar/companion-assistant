...
// ─── Ambient Light — Schedule (Dark) ──────────────────────────
// Smaller, settled — sharing the stage with content.
// Idle breath, gentle warmth drift. Not competing for attention.
function AmbientLightSchedule() {
  ...
  // Slow idle breath (~14s) + long warmth drift (~26s)
  const breath = (Math.sin(t * 0.44) + 1) / 2;
  const warmth = (Math.sin(t * 0.24 + 1.1) + 1) / 2;
  const hue = 28 + warmth * 10;   // 28–38°
  const sat = 76 + breath * 10;
  ...
  return (
    <div className="al-stage-sched">
      ...
      <div className="al-blob-sched" style={{
        ...
        background: `hsl(${hue - 8}, ${sat - 20}%, 24%)`,
      ...
      <div className="al-blob-sched" style={{
        ...
        background: `hsl(${hue - 2}, ${sat - 10}%, 44%)`,
        opacity: 0.42 + breath * 0.16,
        filter: "blur(34px)",
      }} />
      {/* Core */}
      <div className="al-blob-sched" style={{
      ...
      <div className="al-blob-sched" style={{
        ...
        background: `hsl(${hue + 8}, ${sat + 4}%, 80%)`,
        opacity: 0.68 + breath * 0.20,
        filter: "blur(8px)",
      }} />
      {/* Hot point */}
      <div className="al-blob-sched" style={{
...
export function SchedDark() {
  return (
    <div className="sched-root sched-root-dark">
